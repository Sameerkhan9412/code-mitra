...
const Navbar = () => {
  ...
  return (
    <div className='flex h-14  items-center  border-b-yellow font-bold w-full border-b-2 sticky top-0 bg-black ' >
                                ...
                                {0?(
                                 ...
                                 subLinks.length>0 ? (
                                        subLinks.map( (subLink, index) => (
                                                <Link to={`courses/${subLink.name.split(" ").join("-").toLowerCase()}`} key={index} className='rounded-lg bg-transparent py-2 pl-2 hover:bg-yellow hover:text-black'>
                                                    <p>{subLink.name}</p>
                                                </Link>
                                            ) )
