...
export default function MyProfile() {
  ...
  return (
    <div className=" custum-scrollbar">
      ...
      <div className="flex items-center justify-between rounded-md border-2 border-gray-700 bg-richblue-800 p-4 px-8   ">
      ...
      <div className="my-4 flex flex-col gap-y-2 rounded-md border-2 border-gray-700 bg-richblue-800  p-4 px-8">
      ...
      <div className="my-4  flex flex-col gap-y-2 rounded-md border-2 border-gray-700 bg-richblue-800 p-8 px-8">
        <div className="flex w-full items-center justify-between">
